...
| `RETAIL_ORDERS_PERSISTENCE_PROVIDER`         | The persistence provider to use, can be `in-memory` or `mysql`.                         | `in-memory`   |
| `RETAIL_ORDERS_PERSISTENCE_MYSQL_ENDPOINT`    | The MySQL database endpoint.                                                           | `""`          |
| `RETAIL_ORDERS_PERSISTENCE_MYSQL_NAME`        | The MySQL database name                                                                 | `""`          |
| `RETAIL_ORDERS_PERSISTENCE_MYSQL_USERNAME`    | Username to authenticate with MySQL database.                                           | `""`          |
| `RETAIL_ORDERS_PERSISTENCE_MYSQL_PASSWORD`    | Password to authenticate with MySQL database.                                            | `""`          |
